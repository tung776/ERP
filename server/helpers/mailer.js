module.exports = function() {
  ...
  this.forgotPassword = function(options, cb) {
    ...
    mailOptions = {
      ...
      html: _.template(
        fs.readFileSync(
          "public/templates/mailer/forgotPassword.html",
          (encoding = "utf8")
        ),
        templateOptions
      )
  ...
  this.changePassword = function(options) {
    ...
    var mailOptions = {
      ...
      html: _.template(
        fs.readFileSync(
          "public/templates/mailer/changePassword.html",
          (encoding = "utf8")
        ),
        templateOptions
      )
  ...
  this.sendInvoice = function(mailOptions, cb) {
    ...
    mailOptions.html = _.template(
      fs.readFileSync(
        pathMod.join(__dirname, "../public/templates/mailer/sendInvoice.html"),
        (encoding = "utf8")
      ),
      mailOptions
    );
  ...
  this.sendGoodsNote = function(mailOptions, cb) {
    ...
    mailOptions.html = _.template(
      fs.readFileSync(
        pathMod.join(
          __dirname,
          "../public/templates/mailer/sendGoodsNote.html"
        ),
        (encoding = "utf8")
      ),
      {}
  ...
  this.sendAssignedToLead = function(mailOptions, cb) {
    ...
    mailOptions.html = _.template(
      fs.readFileSync(
        "public/templates/mailer/sendAssignedToLead.html",
        (encoding = "utf8")
      ),
      templateOptions
    );
  ...
  this.sendHistory = function(mailOptions, cb) {
    var templateOptions = _.extend(baseOptions, {
      ...
      date: mailOptions.history.date
        ? moment(new Date(mailOptions.history.date)).format(
    ...
    mailOptions.html = _.template(
      fs.readFileSync(
        "public/templates/mailer/historyTemplate.html",
        (encoding = "utf8")
      ),
      templateOptions
    );
  ...
  this.sendEmailFromTask = function(mailOptions, cb) {
    var templateOptions = _.extend(baseOptions, {
      employee: mailOptions.employee,
      to: mailOptions.email,
      date: moment(new Date(mailOptions.date)).format(
        "dddd, MMMM Do YYYY, h:mm:ss a"
      ),
    ...
    mailOptions.html = _.template(
      fs.readFileSync(
        "public/templates/mailer/taskTemplate.html",
        (encoding = "utf8")
      ),
      templateOptions
    );
  ...
  this.sendAddedFollower = function(mailOptions, cb) {
    ...
    var toValidCollectionName =
      collectionName.substr(0, 1).toUpperCase() +
      collectionName.substr(1).toLowerCase();
    var url =
      "http://localhost:8089/#easyErp/" +
      toValidCollectionName +
      "/tform/" +
      contentId;
    ...
    mailOptions.html = _.template(
      fs.readFileSync(
        "public/templates/mailer/addedFollower.html",
        (encoding = "utf8")
      ),
      templateOptions
    );
  ...
  this.registeredNewUserWithToken = function(options, cb) {
    ...
    var mailOptions = {
      ...
      html: _.template(
        fs.readFileSync(
          "public/templates/mailer/registeredNewUser.html",
          (encoding = "utf8")
        ),
        templateOptions
      )
    ...
    var mailOptionsUser = {
      ...
      html: _.template(
        fs.readFileSync(
          "public/templates/mailer/newUser.html",
          (encoding = "utf8")
        ),
        templateOptions
      )
  ...
  this.sendMailFromHelp = function(mailOptions, cb) {
    ...
    mailOptions.html = _.template(
      fs.readFileSync(
        "public/templates/mailer/sendFromHelp.html",
        (encoding = "utf8")
      ),
      templateOptions
    );
