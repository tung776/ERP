export default {
    async deleteCurency(axios, store, currency) {
        try {
    ...
    async getAllCurencies(axios, store) {
        try {
            const result = await axios.get("/currency/getAll");
            store.dispatch("currency/setAllCurrencies", result.data.data)
        } catch (err) {
            console.log(err);
        }
    },
    async saveNewCurrency(axios, newCurrency) {
        console.log("newCurrency = ", newCurrency);
        try {
            // const result = await axios.post("/currency", newCurrency);
        } catch (err) {
            console.log(err);
        }
    },
