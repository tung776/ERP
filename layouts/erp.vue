...
export default {
  ...
  async mounted() {
    try {
      ...
      const menu = [...modules.data];
      menu.forEach(item => {
        switch (item.mname) {
          case "CRM":
            item.icon = "account_box";
            break;
          case "HR":
          ...
          case "Integrations":
            ...
            break;
          case "Purchases":
            item.icon = "flight_takeoff";
            break;
          case "Accounting":
            item.icon = "euro_symbol";
            break;
          case "Inventory":
            item.icon = "business";
            break;
      ...
      await this.$store.dispatch("modules/setModules", menu);
    } catch (error) {
